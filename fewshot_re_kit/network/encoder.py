...
class Encoder(nn.Module):
    def __init__(self, max_length, word_embedding_dim=50, pos_embedding_dim=5, hidden_size=230):
        ...
        self.conv = nn.Conv1d(self.embedding_dim, self.hidden_size, 3, padding=1)  # (batch_size, self.hidden_size, max_length)
        self.pool = nn.MaxPool1d(max_length)  # (batch_size, self.hidden_size, 1)
